...
export const DayOfTheWeek = (props: IDayOfTheWeek) => {
  ...
  return (
    ...
    >
      <Text style={[styles.dayText, { color: isSelected ? theme.APP_WHITE : theme.HABIT_OPTION }]}>
        {day.day}
      </Text>
      <Text
        style={[styles.dayNumber, { color: isSelected ? theme.APP_WHITE : theme.HABIT_OPTION }]}>
