...
import { Habit, HabitHistory, Room, Stats, TColors, TimeOfDay, User } from "~types";
...
export const currentTimeOfDayAtom = atomWithStorage<TimeOfDay>("currentTimeOfDay", TimeOfDay.All);
...
export const selectedTimeOfDayAtom = atomWithStorage<TimeOfDay>("selectedTimeOfDayAtom", TimeOfDay.All);
...
export const habitMarkedAsDoneAtom = atomWithStorage<boolean>("habitMarkedAsDone", false);
